...
function PreUninstall {
  $cs.Log_SectionHeader("PreUninstall",'o')
}

function Uninstall {
  $cs.Log_SectionHeader("Uninstall",'o')

  $cs.Reg_SetDword('HKLM','SOFTWARE\Microsoft\PolicyManager\default\Start\HideShutDown','value',0)
  $cs.Reg_SetDword('HKLM','SOFTWARE\Microsoft\PolicyManager\default\Start\HideSleep','value',0)
}
