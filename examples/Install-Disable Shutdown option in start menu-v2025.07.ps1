...
function Install {
  ...
  $cs.Reg_SetDword('HKLM','SOFTWARE\Microsoft\PolicyManager\default\Start\HideShutDown','value',1)
  $cs.Reg_SetDword('HKLM','SOFTWARE\Microsoft\PolicyManager\default\Start\HideSleep','value',1)
}
