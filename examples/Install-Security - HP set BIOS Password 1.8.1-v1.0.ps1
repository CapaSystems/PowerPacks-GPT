...
$global:DecryptionKey = @(1, 103, 53, 48, 244, 116, 22, 44, 190, 197, 156, 231, 221, 70, 158, 26, 107, 243, 25, 137, 174, 15, 35, 137, 213,180,83,209,91,154,1,248)
# The encrypted password.
$global:EncryptedPassword = ''
...
function Install {
    ...
    $cs.Job_WriteLog('Setting BIOS password.')
		Set-HPBIOSSetupPassword -NewPassword $global:PlaintextPassword
